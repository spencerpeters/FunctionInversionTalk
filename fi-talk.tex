...
\only<5->{
  ...
  % \only<6->{\item Codebreakers and mathematicians have been inverting specific functions for centuries.}
    \only<6->{\item The study of this \emph{black-box} function inversion problem was initiated by Martin Hellman \raisebox{-0.5 \height}{\includegraphics[height=1cm]{assets/hellman.jpeg}} in 1980 \cite{Hellman80}.}
